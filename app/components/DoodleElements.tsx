...
export const Starburst = ({ className = "", style }: DoodleProps) => (
...
export const PencilBrush = ({ className = "", style }: DoodleProps) => (
  <svg viewBox="0 0 120 120" className={className} style={style} fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round">
...
export const ShowTime = ({ className = "", style }: DoodleProps) => (
  <svg viewBox="0 0 120 80" className={className} style={style} fill="none" stroke="currentColor" strokeWidth="2.5">
...
export const Camera = ({ className = "", style }: DoodleProps) => (
  <svg viewBox="0 0 120 100" className={className} style={style} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round">
...
export const BigSpark = ({ className = "", style }: DoodleProps) => (
  <svg viewBox="0 0 100 100" className={className} style={style} fill="currentColor">
